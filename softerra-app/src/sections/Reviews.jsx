    ...
    <section id="reviews" className="relative py-32">
      <div className="mx-auto max-w-7xl px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
          ...
          <h2 className="font-serif text-5xl text-white md:text-6xl">What our clients say<span className="text-[#6B5BFF]">.</span></h2>
          <p className="mt-6 max-w-xl text-white/50">Over 100 five star reviews on Upwork from brands across the world.</p>
        </motion.div>
        <div className="grid gap-6 md:grid-cols-3">
          {reviews.map((r, i) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-white/10 bg-white/[0.02] p-8 transition-all hover:border-[#6B5BFF]/30 hover:bg-[#6B5BFF]/[0.03]"
            >
