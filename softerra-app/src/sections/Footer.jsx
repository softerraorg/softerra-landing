...
export default function Footer() {
  return (
    <footer className="border-t border-white/5 bg-[#070710] py-16">
      <div className="mx-auto grid max-w-7xl gap-12 px-8 md:grid-cols-4">
        ...
        <div>
          <div className="mb-4 text-xs uppercase tracking-[0.2em] text-white/40">Services</div>
        ...
        <div>
          <div className="mb-4 text-xs uppercase tracking-[0.2em] text-white/40">Connect</div>
          <ul className="space-y-2 text-sm text-white/60">
            <li>Upwork</li>
            <li>LinkedIn</li>
            <li>Slack</li>
      ...
      <div className="mx-auto mt-12 flex max-w-7xl items-center justify-between border-t border-white/5 px-8 pt-8 text-xs text-white/30">
